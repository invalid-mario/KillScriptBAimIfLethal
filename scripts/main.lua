...
local ALL_AIM_MODE_MASK = EReflexAimMode.None | EReflexAimMode.OnlyHead | EReflexAimMode.Head | EReflexAimMode.Body
...
local function TrySaveNewConfigForWeapon()
    ...
    if not Config.AutoSaveConfig then
        SendReflexHintNotification("Settings saved for " .. names)
    end
end
